  ...
  return (
    <div className="relative mt-10">
      <div
        ref={scrollRef}
        onScroll={(e) =>
          setHasScrolled(e.currentTarget.scrollLeft > 20)
        }
        className="
      ...
      >
        ...
        <article
          className="
            flex-none overflow-hidden bg-brand-cream rounded-[1.75rem]
            w-[88%] sm:w-[65%] lg:w-[39%]
          "
        >
        ...
        <article
          ...
          "
        >
          <div className="relative aspect-[16/10] bg-brand-purple-dark flex items-center justify-center p-8">
      ...
      {hasScrolled && (
        <button
          ...
          className="
            ...
            text-brand-purple text-3xl font-light
            hover:bg-brand-lilac transition-colors
            z-10
          "
        >
          ‹
